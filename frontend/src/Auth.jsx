...
const navigate=useNavigate();
  const handlerRegister = async (event) => {
    event.preventDefault();
    try {
      const response = await fetch("https://my-blog-app-backend1.onrender.com/api/auth/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          name: registername,
  ...
  const handleLogin = async (event) => {
    event.preventDefault();
    try {
      const response = await fetch("https://my-blog-app-backend1.onrender.com/api/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email: loginemail,
